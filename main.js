...
Also, I don't have branding on this because I'm actually using it to play on my phone, but if you care my twitter handle is @Osorpenke and if you were wondering
[Answer to the puzzle is in the console, but do give it a go]
*/

//console.clear(); //A clean console is a happy console
...
function Generate() {
   ...
   if (
      ...
      As far as I can see the most efficient way is to just start again as it only takes 1 or 2 retries rather than manipulating individual symbols. I can live with myself leaving in the extra miliseconds of delay.
      */
      console.clear();
...
$(document).on(Capture, "#new", function() {
   window.location.reload(false); //By the time I was done this was the easiest solution to reset the game
});
